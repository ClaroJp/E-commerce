...
const getTopSellingProducts = require("../controllers/getTopSellingProducts");
...
router.get("/products/top-sales", getTopSellingProducts);
...
// Create product with image and handle multer errors explicitly
router.post(
  "/products",
  authMiddleware,
  (req, res, next) => {
